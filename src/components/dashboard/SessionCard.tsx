...
export function SessionCard({
  ...
  return (
    <Card
      className={cn(
        "rounded-lg border border-[#E7DDC8] bg-white py-0 shadow-sm transition-colors",
    ...
    >
      <CardContent className="p-0">
        <button
          ...
          className="block w-full rounded-lg p-4 text-left outline-none transition-colors hover:bg-[#FFFDF7] focus-visible:ring-3 focus-visible:ring-[#FECA43]/50 sm:p-5"
        ...
        >
          ...
          <p className="mt-3 line-clamp-2 text-sm leading-relaxed text-gray-600 break-keep">
            {session.summary}
          </p>
