  ...
  return (
    <div className="w-full bg-[#FAF8F5] px-4 pb-4 pt-2">
      ...
      <div className="flex justify-center mb-5">
        <button
          onClick={startVoice}
          className="w-16 h-16 rounded-full bg-[#FECA43] flex items-center justify-center text-white shadow-md active:scale-95 transition"
        >
          <Mic />
        </button>
      </div>
      ...
      <div className="flex items-center bg-white rounded-xl px-3 py-3 shadow-sm">
        ...
        <button onClick={send} className="ml-2 text-gray-700">
