...
export function SettingsDashboard() {
  ...
  return (
    <div className="flex min-h-full w-full flex-1 flex-col bg-[#FFFCF3] transition-colors dark:bg-[#16130A]">
      <section className="mx-auto flex w-full max-w-[944px] flex-1 flex-col px-5 py-9 sm:px-8 lg:px-10">
        ...
        <div className="mt-8 grid gap-4 lg:grid-cols-2">
          <Card className="min-h-[196px] rounded-lg border border-[#E7DDC8] bg-white py-0 shadow-sm transition-colors dark:border-white/8 dark:bg-[#1E1B16] dark:shadow-none">
          ...
          <Card className="min-h-[200px] rounded-lg border border-[#E7DDC8] bg-white py-0 shadow-sm transition-colors dark:border-white/8 dark:bg-[#1E1B16] dark:shadow-none">
            <CardContent className="p-5">
