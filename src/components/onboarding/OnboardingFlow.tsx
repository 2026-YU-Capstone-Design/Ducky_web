...
export function OnboardingFlow() {
  ...
  if (showResult) {
    return (
      <div className={`flex flex-col w-full h-screen items-center justify-center bg-[#FECA43] text-white p-6 transition-all duration-700 ${comfortaa.className}`}>
        <div className="animate-fade-in flex flex-col items-center">
          <h1 className="text-4xl font-bold mb-8 tracking-tight">분석 완료!</h1>

          <div className="bg-white/20 p-8 rounded-3xl backdrop-blur-sm border border-white/30 text-center w-full max-w-sm space-y-6 animate-slide-up">
            <div>
          ...
          <p className="mt-10 font-medium text-white/90 animate-pulse">
      ...
      <div className="flex flex-col w-full min-h-screen bg-[#FAF8F5] items-center">
        ...
        <div className="flex flex-col w-full max-w-sm min-h-screen">
          ...
          <div className="flex flex-col items-center pt-16 pb-6">
            <h1 className={`text-5xl font-bold text-[#FECA43] ${comfortaa.className} select-none tracking-tight`}>
              Ducky
            </h1>
          </div>

          {/* 중앙 콘텐츠 */}
          <div className="flex flex-col items-center flex-1 px-8 pt-12">
            <h2 className="text-2xl font-bold text-gray-900 text-center mb-8">
              학습 유형 검사
            </h2>

            <p className="text-gray-700 text-center text-[15px] leading-relaxed mb-6 break-keep">
              Ducky는 더 적절한 학습 방식을 제공하기 위해<br />
              학습 유형 검사를 근거로 유형을 구분해요.
            </p>

            <p className="text-gray-700 text-center text-[15px] leading-relaxed break-keep">
          ...
          {/* 하단 버튼 영역 */}
          <div className="flex flex-col items-center w-full px-6 pb-12">
            ...
            <button
              ...
              className="w-full py-3 rounded-2xl bg-[#FECA43] text-white font-bold text-xl shadow-sm hover:bg-[#F5B522] transition-all active:scale-[0.98] mb-5"
            >
              진단하기
            </button>
  ...
  return (
    <div className="min-h-screen w-full bg-[#FAF8F5] flex flex-col items-center justify-center overflow-hidden">
      <QuestionCard
